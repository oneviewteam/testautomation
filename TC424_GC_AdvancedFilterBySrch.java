...
public class TC424_GC_AdvancedFilterBySrch {
...
//public  void quoteFromAgreement() throws Throwable {
	...
	// Get sheet by name
	XSSFSheet sheet1=wb.getSheet("TC424");
	...
	Boolean agreementTab =  driver.findElements(By.id("submenulink_157")).size() >0;
	...
	//Find the Advance search link and click the link
	 Boolean advSrch1 = driver.findElements(By.id("drill_grid_customer_all")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_grid_customer_all")).click();
		Thread.sleep(4000);
	}
	
	
	//Find the Advance search link and click the link
	 Boolean advSrchFilter = driver.findElements(By.id("drill_grid_customer_all")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_grid_customer_all")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("drill_grid_customer_all")).click();
		Thread.sleep(2000);
	}
	
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Account_Name));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(AccountID));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(ActiveFlag));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Address));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Address2));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Agreement_End_Date));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Agreement_Start_Date));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Agreement_Type));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(AgreementNumber));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter Days_to_Expiration
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(AgreementTypeID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Brand));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(CFProgramLevelID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(City));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Country));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(CustomerSiteID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(CustomerSiteName));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(CustomerType));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Days_to_Expiration));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(DistributorID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(DistributorName));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(MMI_Created_At_Date));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(MMI_Updated_At_Date));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(ParentAgreementNumber));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(PostalCode));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Program_Level));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(Region_of_Customer_Site));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_customer_all")).sendKeys(String.valueOf(StateProv));
		Thread.sleep(2000);
	...
	//Click the Agreement ID link filter
	Boolean refreshButton = driver.findElements(By.id("refresh_grid_customer_all")).size() >0;
