...
public class TC1441_AdvancedSrch_Criteria extends WebDriverException { //1
...
//----------------------------------------------------------------------------------------------------------------------
			...
			{ //3
				...
				String Template = "Reports_Advanced_Search.xlsx";
				...
				XSSFSheet mySheet = wb.getSheet("TC1441");
			...
			//-----------------------------------------------------------------------------------------------------------------------------------	
				...
				XSSFSheet sheet2 = wb.getSheet("TC1441_AdvancedSrch_Report");
				row = sheet2.getRow(0);
				...
				{//6
					...
					boolean advSrch1 = driver.findElements(By.linkText("Advanced Search")).size() >0;
					...
					WebElement field = driver.findElement(By.linkText(String.valueOf(reportField)));
			...
			//-----------------------------------------------------------------------------------------------------------------------		
				...
				if(! matcher.matches() && driver.findElements(By.id(inputParsed0 + "2_1")).size() >0)
					...
					//boolean loadReport = driver.findElements(By.id("load_report-" + reportParsed)).size() >0;
