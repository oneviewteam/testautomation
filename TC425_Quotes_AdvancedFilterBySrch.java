...
public class TC425_Quotes_AdvancedFilterBySrch {
...
//public  void quoteFromAgreement() throws Throwable {
	...
	// Get sheet by name
	XSSFSheet sheet1=wb.getSheet("TC425");
	...
	Boolean agreementTab =  driver.findElements(By.id("submenulink_118")).size() >0;
			
	if( ! agreementTab)
	{
		//If the tab is not greater than "0", then show "failed"
		sheet1.getRow(9).createCell(9).setCellValue("FAILED");
		sheet1.getRow(9).createCell(8).setCellValue("Quotes Tab Submenu was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(9).createCell(8).setCellValue("Quotes Tab Submenu was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
	...
	if(driver.findElements(By.id("cancelMaingrid_quote")).size()>0) {
	 
		driver.findElement(By.id("cancelMaingrid_quote")).click();
		 Thread.sleep(5000);}
	
	 //Find the Advance search link
	 Boolean advSrch = driver.findElements(By.id("advSrch_grid_quote")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
	    driver.findElement(By.id("advSrch_grid_quote")).click();
	    Thread.sleep(3000);
	}
	
	//Find the Advance search link and click the link
	 Boolean advSrch1 = driver.findElements(By.id("drill_grid_quote")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_grid_quote")).click();
		Thread.sleep(4000);
	}
	
	
	//Find the Advance search link and click the link
	 Boolean advSrchFilter = driver.findElements(By.id("drill_grid_quote")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_grid_quote")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("drill_grid_quote")).click();
		Thread.sleep(2000);
	}
	
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(AccountID));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Account_Name));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Agreement_End_Date));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Agreement_Id));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Agreement_Start_Date));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Agreement_Type));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(AgreementNumber));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(AgreementTypeID));
	Thread.sleep(2000);
	...
	driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Brand));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter Days_to_Expiration
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Created_At));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(CustomerSiteID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(CustomerSiteName));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Days_to_Expiration));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Distributor_Region));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(DistributorID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(DistributorName));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(EndDate));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(ID));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(ParentAgreementNumber));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Program_Level));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(QuoteCreationSource));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(Quoted_by));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(QuoteNumber));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(QuoteStatus));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(RenewalPartNumber));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(RenewalPrice));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(RenewalVolumeDiscount));
		Thread.sleep(2000);
		...
		driver.findElement(By.id("drill_grid_quote")).sendKeys(String.valueOf(StartDate));
		Thread.sleep(2000);
	...
	//Click the Agreement ID link filter
	Boolean refreshButton = driver.findElements(By.id("refresh_grid_quote")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("refresh_grid_quote")).click();
		Thread.sleep(3000);
	}
