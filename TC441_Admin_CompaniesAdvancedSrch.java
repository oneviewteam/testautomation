...
public class TC441_Admin_CompaniesAdvancedSrch {
...
//public  void quoteFromAgreement() throws Throwable {
	...
	// Get sheet by name
	XSSFSheet sheet1=wb.getSheet("TC441");
	...
	Companies_Address1 = sheet1.getRow(3).getCell(10).getStringCellValue();
	Companies_Address2 = sheet1.getRow(4).getCell(10).getStringCellValue();
	Companies_City = sheet1.getRow(5).getCell(10).getStringCellValue();
	Companies_Country_Name = sheet1.getRow(6).getCell(10).getStringCellValue();
	Companies_Id = sheet1.getRow(7).getCell(10).getStringCellValue();
	Companies_Name = sheet1.getRow(8).getCell(10).getStringCellValue();
	Companies_Number = sheet1.getRow(9).getCell(10).getStringCellValue();
	Companies_State_Abbr = sheet1.getRow(10).getCell(10).getStringCellValue();
	Companies_State_Name = sheet1.getRow(11).getCell(10).getStringCellValue();
	Companies_Url = sheet1.getRow(12).getCell(10).getStringCellValue();
	Companies_Zip = sheet1.getRow(13).getCell(10).getStringCellValue();
	Created_At = sheet1.getRow(14).getCell(10).getStringCellValue();
	DistributorID = sheet1.getRow(15).getCell(10).getStringCellValue();
	Email = sheet1.getRow(16).getCell(10).getStringCellValue();
	Fax = sheet1.getRow(17).getCell(10).getStringCellValue();
	Phone = sheet1.getRow(18).getCell(10).getStringCellValue();
	Region = sheet1.getRow(19).getCell(10).getStringCellValue();
	Source = sheet1.getRow(20).getCell(10).getStringCellValue();
	Status_Title = sheet1.getRow(21).getCell(10).getStringCellValue();
	Statuses_Id = sheet1.getRow(22).getCell(10).getStringCellValue();
	Updated_At = sheet1.getRow(23).getCell(10).getStringCellValue();
	...
	//Click on the Agreements tab
		Boolean agreementTab =  driver.findElements(By.id("submenulink_2")).size() >0;
				
		if( ! agreementTab)
		{
			//If the tab is not greater than "0", then show "failed"
			sheet1.getRow(9).createCell(9).setCellValue("FAILED");
			sheet1.getRow(9).createCell(8).setCellValue("Companies Tab Submenu was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(9).createCell(8).setCellValue("Companies Tab Submenu was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("submenulink_2")).click();
			Thread.sleep(5000);
		}
	
	
	 //Find the clear search button and click
	if(driver.findElements(By.id("cancelMaincompanylist")).size()>0) {
	 
		driver.findElement(By.id("cancelMaincompanylist")).click();
		 Thread.sleep(5000);}
	
	 //Find the Advance search link
	 Boolean advSrch = driver.findElements(By.id("advSrch_companylist")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
	    driver.findElement(By.id("advSrch_companylist")).click();
	    Thread.sleep(3000);
	}
	
	//Find the Advance search link and click the link
	 Boolean advSrch1 = driver.findElements(By.id("drill_companylist")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).click();
		Thread.sleep(4000);
	}
	
	
	//Find the Advance search link and click the link
	 Boolean advSrchFilter = driver.findElements(By.id("drill_companylist")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		Thread.sleep(1000);
		driver.findElement(By.id("drill_companylist")).click();
		Thread.sleep(2000);
	}
	
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Address1));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter ID
	 Boolean advSrchFilter1 = driver.findElements(By.linkText(String.valueOf(Companies_Address1))).size() >0;
		
	if ( ! advSrchFilter1)
	{
		sheet1.getRow(13).createCell(9).setCellValue("FAILED");
		sheet1.getRow(13).createCell(8).setCellValue("Companies Address1 field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(13).createCell(8).setCellValue("Companies Address1 field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Address2));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter CustomerSiteID
	 Boolean advSrchFilter2 = driver.findElements(By.linkText(String.valueOf(Companies_Address2))).size() >0;
		
	if ( ! advSrchFilter2)
	{
		sheet1.getRow(14).createCell(9).setCellValue("FAILED");
		sheet1.getRow(14).createCell(8).setCellValue("Companies Address2 field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(14).createCell(8).setCellValue("Companies Address2 field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_City));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter ParentAgreementNumber
	 Boolean advSrchFilter3 = driver.findElements(By.linkText(String.valueOf(Companies_City))).size() >0;
	
	if ( ! advSrchFilter3)
	{
		sheet1.getRow(15).createCell(9).setCellValue("FAILED");
		sheet1.getRow(15).createCell(8).setCellValue("Companies City field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(15).createCell(8).setCellValue("Companies City field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Country_Name));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter Agreement_Type
	 Boolean advSrchFilter4 = driver.findElements(By.linkText(String.valueOf(Companies_Country_Name))).size() >0;
			
	if ( ! advSrchFilter4)
	{
		sheet1.getRow(16).createCell(9).setCellValue("FAILED");
		sheet1.getRow(16).createCell(8).setCellValue("Companies_Country_Name field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(16).createCell(8).setCellValue("Companies_Country_Name field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Id));
	Thread.sleep(2000);
	...
	if ( ! advSrchFilter5)
	{
		...
		sheet1.getRow(17).createCell(8).setCellValue("Companies_Id field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(17).createCell(8).setCellValue("Companies_Id field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Name));
	Thread.sleep(2000);
	...
	if ( ! advSrchFilter6)
	{
		...
		sheet1.getRow(18).createCell(8).setCellValue("Companies_Name field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(18).createCell(8).setCellValue("Companies_Name field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Number));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter AgreementTypeID
	 Boolean advSrchFilter7 = driver.findElements(By.linkText(String.valueOf(Companies_Number))).size() >0;
				
	if ( ! advSrchFilter7)
	{
		sheet1.getRow(19).createCell(9).setCellValue("FAILED");
		sheet1.getRow(19).createCell(8).setCellValue("Companies_Number field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(19).createCell(8).setCellValue("Companies_Number field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_State_Abbr));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter AgreementNumber
	 Boolean advSrchFilter8 = driver.findElements(By.linkText(String.valueOf(Companies_State_Abbr))).size() >0;
				
	if ( ! advSrchFilter8)
	{
		sheet1.getRow(20).createCell(9).setCellValue("FAILED");
		sheet1.getRow(20).createCell(8).setCellValue("Companies_State_Abbr field filter was NOT found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		wb.close();	
		driver.quit();
	...
	else
	{
		...
		sheet1.getRow(20).createCell(8).setCellValue("Companies_State_Abbr field filter was found");
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("drill_companylist")).clear();
		driver.findElement(By.id("drill_companylist")).click();
	...
	driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_State_Name));
	Thread.sleep(2000);
	...
	//Find the Advance search filter box and Enter Days_to_Expiration
		 Boolean advSrchFilter9 = driver.findElements(By.linkText(String.valueOf(Companies_State_Name))).size() >0;
					
		if ( ! advSrchFilter9)
		{
			sheet1.getRow(21).createCell(9).setCellValue("FAILED");
			sheet1.getRow(21).createCell(8).setCellValue("Companies_State_Name field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(21).createCell(8).setCellValue("Companies_State_Name field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Url));
		Thread.sleep(2000);
		...
		//Find the Advance search filter box and Enter CF_License_Value
		 Boolean advSrchFilter10 = driver.findElements(By.linkText(String.valueOf(Companies_Url))).size() >0;
					
		if ( ! advSrchFilter10)
		{
			sheet1.getRow(22).createCell(9).setCellValue("FAILED");
			sheet1.getRow(22).createCell(8).setCellValue("Companies_Url field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(22).createCell(8).setCellValue("Companies_Url field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Companies_Zip));
		Thread.sleep(2000);
		...
		//Find the Advance search filter box and Enter Estimated_CF_Agreement_Value
		 Boolean advSrchFilter11 = driver.findElements(By.linkText(String.valueOf(Companies_Zip))).size() >0;
					
		if ( ! advSrchFilter11)
		{
			sheet1.getRow(23).createCell(9).setCellValue("FAILED");
			sheet1.getRow(23).createCell(8).setCellValue("Companies_Zip field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(23).createCell(8).setCellValue("Companies_Zip field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Created_At));
		Thread.sleep(2000);
		...
		//Find the Advance search filter box and Enter Annualized_CF_Agreement_Value
		 Boolean advSrchFilter12 = driver.findElements(By.linkText(String.valueOf(Created_At))).size() >0;
					
		if ( ! advSrchFilter12)
		{
			sheet1.getRow(24).createCell(9).setCellValue("FAILED");
			sheet1.getRow(24).createCell(8).setCellValue("Created_At field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(24).createCell(8).setCellValue("Created_At field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(DistributorID));
		Thread.sleep(2000);
		...
		//Find the Advance search filter box and Enter CFProgramLevelID
		 Boolean advSrchFilter13 = driver.findElements(By.linkText(String.valueOf(DistributorID))).size() >0;
					
		if ( ! advSrchFilter13)
		{
			sheet1.getRow(25).createCell(9).setCellValue("FAILED");
			sheet1.getRow(25).createCell(8).setCellValue("DistributorID field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(25).createCell(8).setCellValue("DistributorID field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Email));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Email))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter TAMFlag
		 Boolean advSrchFilter14 = driver.findElements(By.linkText(String.valueOf(Email))).size() >0;
					
		if ( ! advSrchFilter14)
		{
			sheet1.getRow(26).createCell(9).setCellValue("FAILED");
			sheet1.getRow(26).createCell(8).setCellValue("Email field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(26).createCell(8).setCellValue("Email field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Fax));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Fax))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter Brand
		 Boolean advSrchFilter15 = driver.findElements(By.linkText(String.valueOf(Fax))).size() >0;
					
		if ( ! advSrchFilter15)
		{
			sheet1.getRow(27).createCell(9).setCellValue("FAILED");
			sheet1.getRow(27).createCell(8).setCellValue("Fax field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(27).createCell(8).setCellValue("Fax field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Phone));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Phone))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter ActiveFlag
		 Boolean advSrchFilter16 = driver.findElements(By.linkText(String.valueOf(Phone))).size() >0;
					
		if ( ! advSrchFilter16)
		{
			sheet1.getRow(28).createCell(9).setCellValue("FAILED");
			sheet1.getRow(28).createCell(8).setCellValue("Phone field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(28).createCell(8).setCellValue("Phone field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Region));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Region))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter DistributorID
		 Boolean advSrchFilter17 = driver.findElements(By.linkText(String.valueOf(Region))).size() >0;
					
		if ( ! advSrchFilter17)
		{
			sheet1.getRow(29).createCell(9).setCellValue("FAILED");
			sheet1.getRow(29).createCell(8).setCellValue("Region field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(29).createCell(8).setCellValue("Region field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Source));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Source))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter Disposition Code
		 Boolean advSrchFilter18 = driver.findElements(By.linkText(String.valueOf(Source))).size() >0;
					
		if ( ! advSrchFilter18)
		{
			sheet1.getRow(30).createCell(9).setCellValue("FAILED");
			sheet1.getRow(30).createCell(8).setCellValue("Source field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(30).createCell(8).setCellValue("Source field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Status_Title));
		Thread.sleep(2000);
		...
		if ( ! advSrchFilter19)
		{
			...
			sheet1.getRow(31).createCell(8).setCellValue("Status_Title field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(31).createCell(8).setCellValue("Status_Title field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Statuses_Id));
		Thread.sleep(2000);
		driver.findElement(By.linkText(String.valueOf(Statuses_Id))).click();
		Thread.sleep(2000);
		
		//Find the Advance search filter box and Enter category
		 Boolean advSrchFilter20 = driver.findElements(By.linkText(String.valueOf(Statuses_Id))).size() >0;
					
		if ( ! advSrchFilter20)
		{
			sheet1.getRow(32).createCell(9).setCellValue("FAILED");
			sheet1.getRow(32).createCell(8).setCellValue("Statuses_Id field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(32).createCell(8).setCellValue("Statuses_Id field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
		...
		driver.findElement(By.id("drill_companylist")).sendKeys(String.valueOf(Updated_At));
		Thread.sleep(2000);
		...
		//Find the Advance search filter box and Enter Disposition_status
		 Boolean advSrchFilter21 = driver.findElements(By.linkText(String.valueOf(Updated_At))).size() >0;
					
		if ( ! advSrchFilter21)
		{
			sheet1.getRow(33).createCell(9).setCellValue("FAILED");
			sheet1.getRow(33).createCell(8).setCellValue("Updated_At field filter was NOT found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			wb.close();	
			driver.quit();
		...
		else
		{
			...
			sheet1.getRow(33).createCell(8).setCellValue("Updated_At field filter was found");
			FileOutputStream fout=new FileOutputStream(src);
			wb.write(fout);
			driver.findElement(By.id("drill_companylist")).clear();
			driver.findElement(By.id("drill_companylist")).click();
	...
	//Click the Agreement ID link filter
	Boolean refreshButton = driver.findElements(By.id("refresh_companylist")).size() >0;
	...
	else
	{
		...
		FileOutputStream fout=new FileOutputStream(src);
		wb.write(fout);
		driver.findElement(By.id("refresh_companylist")).click();
		Thread.sleep(3000);
	}
